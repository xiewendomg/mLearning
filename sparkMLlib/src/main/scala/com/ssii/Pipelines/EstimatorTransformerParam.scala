...
object EstimatorTransformerParam {
  def main(args: Array[String]): Unit = {
    ...
    model2.transform(test)
      ...
      .collect()
      .foreach { case Row(features: org.apache.spark.ml.linalg.Vector, label: Double, prob: org.apache.spark.ml.linalg.Vector, prediction: Double) =>
